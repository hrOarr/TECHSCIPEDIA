...
if(!$current_user)$current_user = $_SESSION['profile'];
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5">
                        <div class="container" align="center" style="margin-top: 20px;margin-bottom:20px;background-color: #fff;">
                          <?php
                           ...
                           echo "</br>";
                          ?>
                          <a href="update-profile.php?user=<?php echo $row['Username']; ?>"><button type="button" style="cursor: pointer;">update</button></a>
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-7 col-xs-7">
                        <div class="container" style="margin-top: 20px;margin-bottom:20px;background-color: #fff;">
                          ...
                          <?php
                           ...
                           echo "<span style='font-family: serif;font-size:20px;'>Email : </span>".$row['Email']."</br>";
