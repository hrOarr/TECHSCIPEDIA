...
<head>
    ...
    <title>login(admin) | TechSci Room</title>
...
<body>
<div class="container">
  <p style="font-weight: bold;margin-top: 40px;">Fill in the form to signin into TECHSCIPEDIA(admin).</p>
 ...
 <form action="" method="post" name="vform" onsubmit="return Validate()" style="border:1px solid #ccc">
  ...
  <div class="container">
    <p style="font-weight: bold;color: #074861;font-size: 23px;">Signin into Bookpalace</p>
    <hr>
 ...
 <div class="col-md-10 col-xs-8">
     New admin?<a href="signup.php" style="text-decoration: underline;">Register</a>
    </div>
</div>
</div>
  </div>
